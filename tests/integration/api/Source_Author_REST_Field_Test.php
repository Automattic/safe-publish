...
/**
 * Source Author REST Field Test.
 *
 * Verifies that the safe_publish_author REST field is only populated for
 * Safe Publish HMAC-authenticated requests and that its payload reflects the
