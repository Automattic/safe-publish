...
- **Content filtering**: Applies WordPress' normal save filters for the acting user and reports an error if the persisted content differs from the requested content.
