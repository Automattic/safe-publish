...
changed. Terms used only to preserve the hierarchy appear in a separate
**Related hierarchy terms** block, rather than among the terms assigned to the
post. A taxonomy this site registers and the source does not send is not
